...
- **Cross-Language**: Rust, Python, Node.js 세 가지 환경에서 동일한 로직을 지원합니다.
- **Cunning Offset System**: NICE PASS 특유의 숫자 간 커닝(Kerning) 규칙을 수학적으로 분석하여, 다음 숫자의 위치를 ±2px 오차 범위 내에서 완벽하게 예측합니다.
...
모든 도구는 이미지 파일이 들어있는 **폴더 경로**를 인자로 받으며, 파일명(예: `123456.png`)을 정답으로 간주하여 정답률을 측정합니다.
...
제미나이클로드도고마워
---
⭐ 프로젝트가 도움이 되셨다면 **Star**를 눌러주세요! 모든 문의는 Issue를 통해 남겨주시기 바랍니다.
